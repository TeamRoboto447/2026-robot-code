...
public class ShipOfTheseus {
    ...
    private void configureBindings() {
        ...
        DriverController.pov(90).whileTrue(motorTestingSubsystem.run(() -> intakeSubsystem.intake(0.8)));
        DriverController.pov(270).whileTrue(motorTestingSubsystem.run(() -> intakeSubsystem.reverseIntake(0.8)));
