...
public class ShipOfTheseus {
    ...
    private void configureBindings() {
        ...
        DriverController.pov(90).whileTrue(motorTestingSubsystem.run(() -> motorTestingSubsystem.setPercent(1)));
        DriverController.pov(270).whileTrue(motorTestingSubsystem.run(() -> motorTestingSubsystem.setPercent(-1)));
