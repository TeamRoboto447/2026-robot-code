...
package frc.robot.libraries.Repulsor.Fields;

import static frc.robot.Constants.RepulsorConstants.FIELD_LENGTH;
...
import frc.robot.libraries.Repulsor.FieldPlanner.Obstacles.CorridorCenterlineRail;
import frc.robot.libraries.Repulsor.FieldPlanner.Obstacles.GatedAttractorObstacle;
import frc.robot.libraries.Repulsor.FieldPlanner.Obstacles.HorizontalObstacle;
import frc.robot.libraries.Repulsor.FieldPlanner.Obstacles.RectangleObstacle;
import frc.robot.libraries.Repulsor.FieldPlanner.Obstacles.VerticalObstacle;
import frc.robot.libraries.Repulsor.Fields.FieldMapBuilder.CategorySpec;
import frc.robot.libraries.Repulsor.Heatmap;
