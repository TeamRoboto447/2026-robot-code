 ...
 */
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements PoseProvider, DriveRepulsor {
    ...
    /**
     * Constructs a CTRE SwerveDrivetrain using the specified constants and a
     * custom odometry update frequency, while also accepting a {@link Field2d}
     * for dashboard visualization.
     *
     * @param fieldImport             Field2d for SmartDashboard display
     * @param drivetrainConstants     Drivetrain-wide constants for the swerve drive
    ...
    public void driveWithChassisSpeeds(ChassisSpeeds speeds) {
        this.setControl(this.chassisSpeeds.withSpeeds(speeds));
    }
    ...
    // TODO: put this controller elsewhere and tune it
    private final PIDController omegaPid = new PIDController(3.0, 0.0, 0.1);

    @Override
    public void runVelocity(ChassisSpeeds speeds) {
        this.driveWithChassisSpeeds(speeds);
    }
    ...
    private void configureAutoBuilder() {
        try {
            ...
            new PPHolonomicDriveController(
                new PIDConstants(3.0, 0.0, 0), // kP: 6.0
